...
| :--- | :---: | :---: | :---: |
| **Normal HTTP URL** | ~1.03 µs/iter | ~4.33 µs/iter | ~4.23 µs/iter |
| **XSS URL** | ~5.68 µs/iter | ~1.61 µs/iter | ~9.51 µs/iter |
| **Complex Data URL** | ~175.71 µs/iter | ~2.77 µs/iter | ~10.01 µs/iter |
