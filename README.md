...
| :--- | :---: | :---: | :---: |
| **Normal HTTP URL** | ~0.98 µs/iter | ~4.28 µs/iter | ~4.09 µs/iter |
| **XSS URL** | ~5.39 µs/iter | ~1.61 µs/iter | ~9.50 µs/iter |
| **Complex Data URL** | ~460.98 µs/iter | ~2.79 µs/iter | ~9.59 µs/iter |
