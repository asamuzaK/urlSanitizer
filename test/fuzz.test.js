...
describe('Fuzz Testing (Property-based Testing)', () => {
  describe('sanitizeURLSync', () => {
    ...
    it('should never crash and always return null for javascript: URLs', () => {
      fc.assert(
        fc.property(fc.string({ maxLength: 5000 }), randomScript => {
          ...
          (scheme, ctrls, suffix) => {
            ...
            try {
              ...
              if (e.message !== 'Character references nested too deeply.') {
                console.error(
                  'Unhandled crash in data URL with control char:',
                  dataUrl,
                  e
                );
                return false;
            ...
            try {
              ...
              if (
                ...
                console.error(
                  'Bypass detected via direct obfuscated URL:',
                  directUrl,
                  'Result:',
                  res
                );
              ...
              console.error(
                'Unhandled crash in direct URL with control char:',
                directUrl,
                e
              );
              return false;
        ...
        fc.property(
          ...
          (scheme, entities, depth, suffix) => {
            ...
            try {
              ...
              if (e.message !== 'Character references nested too deeply.') {
                console.error(
                  'Unhandled crash in data URL with nested entity:',
                  dataUrl,
                  e
                );
                return false;
        ...
        fc.property(
          ...
          (obfuscatedScheme, suffix) => {
            ...
            try {
              ...
              console.error(
                'Unhandled crash in Unicode obfuscated URL:',
                directUrl,
                e
              );
              return false;
            ...
            try {
              ...
              if (e.message !== 'Character references nested too deeply.') {
                console.error(
                  'Unhandled crash in Unicode obfuscated Data URL:',
                  dataUrl,
                  e
                );
                return false;
    ...
    it('should correctly handle mixed encoding bypass attempts', () => {
      ...
      const mixedSchemeArb = fc
        .constantFrom('javascript', 'vbscript')
        .chain(scheme => {
          return fc
            .array(fc.constantFrom(...encodeTypes), {
              minLength: scheme.length,
              maxLength: scheme.length
            })
            .map(encodings => {
        ...
        fc.property(
          ...
          (obfuscatedScheme, suffix) => {
            ...
            try {
              ...
              console.error(
                'Unhandled crash in Mixed Encoding URL:',
                directUrl,
                e
              );
              return false;
            ...
            try {
              ...
              if (e.message !== 'Character references nested too deeply.') {
                console.error(
                  'Unhandled crash in Mixed Encoding Data URL:',
                  dataUrl,
                  e
                );
                return false;
    ...
    it('should correctly handle scheme splitting bypass attempts', () => {
      ...
      const splitSchemeArb = fc
        .constantFrom('javascript', 'vbscript')
        .chain(scheme => {
          return fc
            .array(fc.constantFrom(...splitters), {
        ...
        fc.property(
          ...
          (obfuscatedScheme, suffix) => {
            ...
            try {
              ...
              if (e.message !== 'Character references nested too deeply.') {
                console.error(
                  'Unhandled crash in Scheme Splitting Data URL:',
                  dataUrl,
                  e
                );
                return false;
      ...
      fc.assert(
        fc.property(fc.webUrl(), optionsArb, (url, opts) => {
          try {
            ...
            if (e instanceof RangeError && e.message.includes('exceeds max length')) {
              return true;
            }
    ...
    it('should handle potentially expensive repeating characters without ReDoS', () => {
      const redosArb = fc
        .array(fc.constantFrom('%', '&', 'a', ';', '0', '#', 'x'), { maxLength: 10000 })
        .map(arr => arr.join(''));
    ...
    it('should correctly handle Unicode case-folding anomalies (e.g., Long S)', () => {
      ...
      const anomalySchemeArb = fc.constantFrom('javascript', 'vbscript').chain(scheme => {
        return fc
      ...
      await fc.assert(
        fc.asyncProperty(fc.webUrl(), optionsArb, async (url, opts) => {
          try {
            ...
            console.error('Unhandled async crash with randomized options:', opts, e);
            return false;
          }
        }),
        { numRuns: 1000, verbose: fc.VerbosityLevel.Verbose }
